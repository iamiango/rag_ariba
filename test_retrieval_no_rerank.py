#!/usr/bin/env python3
"""测试检索功能和元数据（禁用rerank）"""
from backend import retrieval_processor, config

# 临时禁用rerank
original_rerank = config.config.RERANK_ENABLED
config.config.RERANK_ENABLED = False

# 测试检索
print("测试检索功能（禁用rerank）...")
print("="*60)
...
# 恢复配置
config.config.RERANK_ENABLED = original_rerank
